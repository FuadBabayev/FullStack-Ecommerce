            ...
            <div className="w-full lg:w-2/6 px-4 mb-12 lg:mb-0">
              <div className="py-20 text-center">
                ...
                <form onSubmit={onSubmitHandler}>
                  ...
                  />
                  {loading ? <LoadingComponent /> : <button disabled={loading}
                    className="mt-12 md:mt-16 bg-blue-800 hover:bg-blue-900 text-white font-bold font-heading py-5 px-8 rounded-md uppercase">Register</button>}
                </form>
              </div>
            </div>
          </div>
