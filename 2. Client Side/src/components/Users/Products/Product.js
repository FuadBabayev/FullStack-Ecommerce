...
import { addOrderToCartAction, cartItemFromLocalStorageAction } from "../../../redux/slices/cart/cartSlice";
import { sweetError } from "../../ErrorMsg/ErrorMsg";
import { sweetSuccess } from "../../SuccessMsg/SuccessMsg";
...
export default function Product() {
  ...
  // Get data from Store
  const { product: { product }, error, loading } = useSelector((state) => state?.products);
  ...
  const addToCartHandler = () => {
    ...
    if (productExist) return sweetError("This product is already in Cart");
    ...
    sweetSuccess("Product added to Cart Succesfully");
    return dispatch(cartItemFromLocalStorageAction());
  };
            ...
            <div className="mt-4">
              ...
              <div className="flex items-center">
                <p className="text-sm text-gray-700">
                  {product?.reviews?.length > 0 ? product?.averageRate.slice(0, 3) : null}
