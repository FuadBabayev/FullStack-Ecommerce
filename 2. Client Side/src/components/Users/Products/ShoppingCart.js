...
import { cartItemFromLocalStorageAction, changeOrderItemQty, removeOrderItemQty } from "../../../redux/slices/cart/cartSlice";
        ...
        <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                    ...
                    <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                      ...
                      <div className="mt-4 sm:mt-0 sm:pr-9">
                        ...
                        <select
                          ...
                          {/* use the qty  */}
                          {[...Array(product?.qtyLeft).keys()].map((x) => <option key={x} value={x + 1}>{x + 1}</option>)}
                        </select>
                        {/* remove */}
          ...
          <section
            ...
            <dl className="mt-6 space-y-4">
              ...
              {isAdded && <SuccessMsg message={`You get ${coupon?.coupon?.discount}% discount from ${couponCode} coupon`} />}
