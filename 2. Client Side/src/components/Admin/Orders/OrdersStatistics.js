...
import { fetchOrdersStatisticsAction } from "../../../redux/slices/orders/orderSlice";
...
export default function OrdersStats() {
  ...
  const stats = obj ? Object.values(obj[0]) : [];
  return (
    <div>
      <dl className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="relative overflow-hidden rounded-lg bg-red-800 px-4 pt-5 pb-12 shadow sm:px-6 sm:pt-6">
          ...
          <dd className="ml-16 flex items-baseline pb-6 sm:pb-7">
            <p className="text-2xl font-semibold text-gray-200">${stats[2]}</p>
        ...
        <div className="relative overflow-hidden rounded-lg bg-yellow-600 px-4 pt-5 pb-12 shadow sm:px-6 sm:pt-6">
          ...
          <dd className="ml-16 flex items-baseline pb-6 sm:pb-7">
            <p className="text-2xl font-semibold text-gray-200">${stats[3]}</p>
        ...
        <div className="relative overflow-hidden rounded-lg bg-green-600 px-4 pt-5 pb-12 shadow sm:px-6 sm:pt-6">
          ...
          <dd className="ml-16 flex items-baseline pb-6 sm:pb-7">
            <p className="text-2xl font-semibold text-gray-200">${stats[1]}</p>
        ...
        {/* <div className="relative overflow-hidden rounded-lg bg-pink-600 px-4 pt-5 pb-12 shadow sm:px-6 sm:pt-6">
          ...
          <dd className="ml-16 flex items-baseline pb-6 sm:pb-7">
            <p className="text-2xl font-semibold text-gray-200">${stats[4]}</p>
        ...
        {/* Today Sales */}
        <div className="relative overflow-hidden rounded-lg bg-indigo-900 px-4 pt-5 pb-12 shadow sm:px-6 sm:pt-6">
          <dt>
            <div className="absolute rounded-md bg-indigo-500 p-3">
              <svg
                className="h-6 w-6 text-white"
          ...
          <dd className="ml-16 flex items-baseline pb-6 sm:pb-7">
            <p className="text-2xl font-semibold text-gray-200">{statistics?.saleToday?.length <= 0 ? "$0.00" : 0}</p>
