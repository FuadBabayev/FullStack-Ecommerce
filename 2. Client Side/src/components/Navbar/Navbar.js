...
import { fetchCategoriestAction } from "../../redux/slices/categories/categorySlice";
import { cartItemFromLocalStorageAction } from "../../redux/slices/cart/cartSlice";
  ...
  return (
    <div className="bg-white">
      ...
      <header className="relative z-10">
        <nav aria-label="Top">
          {/* Coupon Navbar */}
          {!currentCoupon?.isExpired && <div className="bg-yellow-500">
            <div className="mx-auto flex h-10 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
              <p style={{ textAlign: "center", width: "100%" }} className="flex-1 text-center text-sm font-medium text-white lg:flex-none">
                {currentCoupon ? `${currentCoupon?.code} - ${currentCoupon?.discount}%, ${currentCoupon?.daysLeft} ` : "No Flash sale at the moment"}
              </p>
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                  ...
                  <div className="flex flex-1 items-center justify-end">
                    {user?.userFound?.isAdmin && <Link to="/admin" type="button" className="inline-flex items-center rounded-md border border-transparent bg-red-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus: ring-2 focus:ring-indigo-500 focus:ring-offset-2">Admin Dashboard</Link>
                    }
                    <div className="flex items-center lg:ml-8">
                      <div className="flex space-x-8">
                        {isLoggedIn && <div className="flex">
                          ...
                          {/* Log out */}
                          <button onClick={logOutHandler}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 text-gray-500">
